...
patients_ub_lof_mut_path <- file.path(results_ubfora_path, 
                      "lof_patients_ub_mutations.csv")
write.csv(joined_ub_info, file = patients_ub_lof_mut_path, row.names = TRUE)
...
write.csv(combined_df, file = unique_shared_genes_path, row.names = TRUE)
