...
# Save the ub_db in a csv file
ub_db_csv_path <- file.path(results_ubgenesets_path, "ub_db.csv")
write.csv(final_ub_db_df, file = ub_db_csv_path, row.names = TRUE)
...
plot_path <- file.path(figures_ubgenesets_path, "mm909_combinedGS_lof_heat_map.pdf")
...
plot_path <- file.path(figures_ubgenesets_path, "mm909_combinedGS_cat_lof_heat_map.pdf")
...
#10 Perform FORA analysis
# Define paths
fora_results_all_csv_path_mygene <- file.path(results_ubgenesets_path, "fora_results_ubiquitin_all_mygene.csv")
fora_results_nonsyn_csv_path_mygene <- file.path(results_ubgenesets_path, "fora_results_ubiquitin_nonsyn_mygene.csv")
fora_results_lof_csv_path_mygene <- file.path(results_ubgenesets_path, "fora_results_ubiquitin_lof_mygene.csv")
...
```{r, message=FALSE, warning=FALSE, fig.width=10, fig.height=6}
# Define output path
mm909_ubiquitin_lof_plot_path_mygene <- file.path(figures_ubgenesets_path,
...
```{r, warning=FALSE, message=FALSE, fig.width=10, fig.height=10}
plot_path_mygene <- file.path(figures_ubgenesets_path, "mm909_combinedGS_lof_heat_map_mygene.pdf")
