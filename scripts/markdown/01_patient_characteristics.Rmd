...
if(!file.exists(results_pc_path)) {
  dir.create(results_pc_path, recursive = TRUE)
}
...
# Create the folder if it does not exist
if(!file.exists(figures_pc_path)) {
  dir.create(figures_pc_path, recursive = TRUE)
}
...
cbPalette <- c("#56B4E9", "#999999", "purple", "#E69F00", "#D55E00", "#CC79A7", "#009E73", "#F0E442", "#0072B2")
