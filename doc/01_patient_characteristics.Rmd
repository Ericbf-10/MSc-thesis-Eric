...
```{r}
datatable(sup1_final, extensions = c('Buttons', 'FixedColumns'), options = list(
  dom = 'Bfrtip',
...
datatable(rows_with_na, extensions = c('Buttons', 'FixedColumns'), options = list(
dom = 'Bfrtip',
buttons = c('copy', 'excel', 'csv'),
scrollX=TRUE,
pageLength=5,
...
# Display the result
datatable(sorted_ids, extensions = 'Buttons', options = list(
dom = 'Bfrtip',
buttons = c('copy', 'excel', 'csv'),
scrollX=TRUE,
pageLength=24,
...
is_id_present <- sapply(search_ids, function(id) any(str_detect(sorted_ids$tumor_name, id)))
# Combine the IDs and their presence status into a data frame for easy viewing
patients_present <- data.frame(ID = search_ids, IsPresent = is_id_present)
# Display the results
datatable(patients_present, extensions = 'Buttons', options = list(
dom = 'Bfrtip',
buttons = c('copy', 'excel', 'csv'),
scrollX=TRUE,
pageLength=24,
