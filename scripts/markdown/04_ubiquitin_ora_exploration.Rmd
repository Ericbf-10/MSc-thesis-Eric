...
date: '`r paste("First created on February 2024. Updated on ", format(Sys.Date(), "%d %B %Y"))`'
output:
  html_document:
    css: style.css
    code_folding: hide
...
if(!file.exists(results_ubi_ora_exp_path)) {
  dir.create(results_ubi_ora_exp_path, recursive = TRUE)
}
...
# Create the folder if it does not exist
if(!file.exists(figures_ubi_ora_exp_path)) {
  dir.create(figures_ubi_ora_exp_path, recursive = TRUE)
}
...
# Define output path
mm909_sum_plot_path <- file.path(figures_ubi_ora_exp_path,
                              "mm909_sum_plot.png")
...
```{r, message=FALSE, warning=FALSE}
# Define paths
fora_results_all_csv_path <- file.path(results_ubi_ora_exp_path, "fora_results_c5bp_all.csv")
fora_results_nonsyn_csv_path <- file.path(results_ubi_ora_exp_path, "fora_results_c5bp_nonsyn.csv")
fora_results_lof_csv_path <- file.path(results_ubi_ora_exp_path, "fora_results_c5bp_lof.csv")
...
# Define output path
mm909_c5bp_all_plot_path <- file.path(figures_ubi_ora_exp_path,
...
```{r, message=FALSE, warning=FALSE, fig.width=12, fig.height=5}
# Define output path
mm909_c5bp_nonsyn_plot_path <- file.path(figures_ubi_ora_exp_path,
...
```{r, message=FALSE, warning=FALSE, fig.width=12, fig.height=5}
# Define output path
mm909_c5bp_lof_plot_path <- file.path(figures_ubi_ora_exp_path,
...
```{r, message=FALSE, warning=FALSE}
# Define paths
fora_results_all_csv_path <- file.path(results_ubi_ora_exp_path, "fora_results_c5cc_all.csv")
fora_results_nonsyn_csv_path <- file.path(results_ubi_ora_exp_path, "fora_results_c5cc_nonsyn.csv")
fora_results_lof_csv_path <- file.path(results_ubi_ora_exp_path, "fora_results_c5cc_lof.csv")
...
```{r, message=FALSE, warning=FALSE, fig.width=12, fig.height=5}
# Define output path
mm909_c5cc_proteasome_lof_plot_path <- file.path(figures_ubi_ora_exp_path,
...
```{r, message=FALSE, warning=FALSE}
# Define paths
fora_results_all_csv_path <- file.path(results_ubi_ora_exp_path, "fora_results_h_all.csv")
fora_results_nonsyn_csv_path <- file.path(results_ubi_ora_exp_path, "fora_results_h_nonsyn.csv")
fora_results_lof_csv_path <- file.path(results_ubi_ora_exp_path, "fora_results_h_lof.csv")
...
<!-- ```{r, message=FALSE, warning=FALSE, fig.width=12, fig.height=5} -->
<!-- # Define output path -->
<!-- mm909_h_all_plot_path <- file.path(figures_ubi_ora_exp_path, -->
...
```{r, message=FALSE, warning=FALSE, fig.width=12, fig.height=5}
# Define output path
mm909_h_nonsyn_plot_path <- file.path(figures_ubi_ora_exp_path,
...
```{r, message=FALSE, warning=FALSE, fig.width=12, fig.height=5}
# Define output path
mm909_h_lof_plot_path <- file.path(figures_ubi_ora_exp_path,
...
# Define output path
mm909_h_apoptosis_plot_path <- file.path(figures_ubi_ora_exp_path,
...
```{r, message=FALSE, warning=FALSE}
# Define paths
fora_results_all_csv_path <- file.path(results_ubi_ora_exp_path, "fora_results_c6_all.csv")
fora_results_nonsyn_csv_path <- file.path(results_ubi_ora_exp_path, "fora_results_c6_nonsyn.csv")
fora_results_lof_csv_path <- file.path(results_ubi_ora_exp_path, "fora_results_c6_lof.csv")
...
<!-- ```{r, message=FALSE, warning=FALSE, fig.width=12, fig.height=5} -->
<!-- # Define output path -->
<!-- mm909_c6_all_plot_path <- file.path(figures_ubi_ora_exp_path, -->
...
<!-- # Define output path -->
<!-- mm909_c6_nonsyn_plot_path <- file.path(figures_ubi_ora_exp_path, -->
...
<!-- ```{r, message=FALSE, warning=FALSE, fig.width=15, fig.height=20} -->
<!-- # Define output path -->
<!-- mm909_c6_lof_plot_path <- file.path(figures_ubi_ora_exp_path, -->
...
```{r, message=FALSE, warning=FALSE}
# Define paths
fora_results_all_csv_path <- file.path(results_ubi_ora_exp_path, "fora_results_c7_all.csv")
fora_results_nonsyn_csv_path <- file.path(results_ubi_ora_exp_path, "fora_results_c7_nonsyn.csv")
fora_results_lof_csv_path <- file.path(results_ubi_ora_exp_path, "fora_results_c7_lof.csv")
...
```{r, message=FALSE, warning=FALSE, fig.width=15, fig.height=20}
# Define output path
mm909_c7_all_plot_path <- file.path(figures_ubi_ora_exp_path,
...
# Define output path
mm909_c7_nonsyn_plot_path <- file.path(figures_ubi_ora_exp_path,
...
# Define output path
mm909_c7_lof_plot_path <- file.path(figures_ubi_ora_exp_path,
...
```{r, message=FALSE, warning=FALSE}
# Define paths
fora_results_all_csv_path <- file.path(results_ubi_ora_exp_path, "fora_results_ubiquitin_all.csv")
fora_results_nonsyn_csv_path <- file.path(results_ubi_ora_exp_path, "fora_results_ubiquitin_nonsyn.csv")
fora_results_lof_csv_path <- file.path(results_ubi_ora_exp_path, "fora_results_ubiquitin_lof.csv")
...
```{r, message=FALSE, warning=FALSE, fig.width=10, fig.height=10}
# Define output path
mm909_ubiquitin_all_plot_path <- file.path(figures_ubi_ora_exp_path,
...
```{r, message=FALSE, warning=FALSE, fig.width=10, fig.height=10}
# Define output path
mm909_ubiquitin_nonsyn_plot_path <- file.path(figures_ubi_ora_exp_path,
...
```{r, message=FALSE, warning=FALSE, fig.width=10, fig.height=10}
# Define output path
mm909_ubiquitin_lof_plot_path <- file.path(figures_ubi_ora_exp_path,
...
```{r, message=FALSE, warning=FALSE}
# Define paths
fora_results_all_csv_path <- file.path(results_ubi_ora_exp_path, "fora_results_c2cgp_all.csv")
fora_results_nonsyn_csv_path <- file.path(results_ubi_ora_exp_path, "fora_results_c2cgp_nonsyn.csv")
fora_results_lof_csv_path <- file.path(results_ubi_ora_exp_path, "fora_results_c2cgp_lof.csv")
...
# Define output path
mm909_c2cgp_all_plot_path <- file.path(figures_ubi_ora_exp_path,
...
```{r, message=FALSE, warning=FALSE, fig.width=10, fig.height=5}
# Define output path
mm909_c2cgp_nonsyn_plot_path <- file.path(figures_ubi_ora_exp_path,
...
```{r, message=FALSE, warning=FALSE, fig.width=10, fig.height=5}
# Define output path
mm909_c2cgp_lof_plot_path <- file.path(figures_ubi_ora_exp_path,
...
```{r, message=FALSE, warning=FALSE}
# Define paths
fora_results_all_csv_path <- file.path(results_ubi_ora_exp_path, "fora_results_keggmed_all.csv")
fora_results_nonsyn_csv_path <- file.path(results_ubi_ora_exp_path, "fora_results_keggmed_nonsyn.csv")
fora_results_lof_csv_path <- file.path(results_ubi_ora_exp_path, "fora_results_keggmed_lof.csv")
...
```{r, message=FALSE, warning=FALSE, fig.width=10, fig.height=5}
# Define output path
mm909_keggmed_all_plot_path <- file.path(figures_ubi_ora_exp_path,
...
```{r, message=FALSE, warning=FALSE, fig.width=10, fig.height=5}
# Define output path
mm909_keggmed_nonsyn_plot_path <- file.path(figures_ubi_ora_exp_path,
...
<!-- ```{r, message=FALSE, warning=FALSE, fig.width=15, fig.height=20} -->
<!-- # Define output path -->
<!-- mm909_keggmed_lof_plot_path <- file.path(figures_ubi_ora_exp_path, -->
...
```{r, message=FALSE, warning=FALSE}
# Define paths
fora_results_all_csv_path <- file.path(results_ubi_ora_exp_path, "fora_results_reactome_all.csv")
fora_results_nonsyn_csv_path <- file.path(results_ubi_ora_exp_path, "fora_results_reactome_nonsyn.csv")
fora_results_lof_csv_path <- file.path(results_ubi_ora_exp_path, "fora_results_reactome_lof.csv")
...
# Define output path
mm909_reactome_all_plot_path <- file.path(figures_ubi_ora_exp_path,
...
```{r, message=FALSE, warning=FALSE, fig.width=12, fig.height=10}
# Define output path
mm909_reactome_nonsyn_plot_path <- file.path(figures_ubi_ora_exp_path,
...
```{r, message=FALSE, warning=FALSE, fig.width=12, fig.height=10}
# Define output path
mm909_reactome_lof_plot_path <- file.path(figures_ubi_ora_exp_path,
...
```{r, message=FALSE, warning=FALSE}
# Define paths
fora_results_all_csv_path <- file.path(results_ubi_ora_exp_path, "fora_results_proteasome_all.csv")
fora_results_nonsyn_csv_path <- file.path(results_ubi_ora_exp_path, "fora_results_proteasome_nonsyn.csv")
fora_results_lof_csv_path <- file.path(results_ubi_ora_exp_path, "fora_results_proteasome_lof.csv")
...
# Define output path
mm909_proteasome_all_plot_path <- file.path(figures_ubi_ora_exp_path,
...
```{r, message=FALSE, warning=FALSE, fig.width=12, fig.height=8}
# Define output path
mm909_proteasome_nonsyn_plot_path <- file.path(figures_ubi_ora_exp_path,
...
# Define output path
mm909_proteasome_lof_plot_path <- file.path(figures_ubi_ora_exp_path,
...
```{r, message=FALSE, warning=FALSE, fig.width=10, fig.height=5}
# Define output path
mm909_keggproteasome_lof_plot_path <- file.path(figures_ubi_ora_exp_path,
                              "mm909_proteasome_lof_plot.png")
...
```{r, message=FALSE, warning=FALSE}
# Define paths
fora_results_all_csv_path <- file.path(results_ubi_ora_exp_path, "fora_results_combinedGS_all.csv")
fora_results_nonsyn_csv_path <- file.path(results_ubi_ora_exp_path, "fora_results_combinedGS_nonsyn.csv")
fora_results_lof_csv_path <- file.path(results_ubi_ora_exp_path, "fora_results_combinedGS_lof.csv")
...
for(sample_id in unique_sample_ids) {
  ...
  plot_path <- file.path(figures_ubi_ora_exp_path, paste0(sample_id, "_combinedGS_lof_barplot.png"))
...
for(geneset in names(gene_sets_list)) {
  ...
  plot_path <- file.path(figures_ubi_ora_exp_path, paste0(geneset, "_combinedGS_lof_bubbleplot.png"))
...
for (i in indices) {
  ...
  plot_path <- file.path(figures_ubi_ora_exp_path, paste0(global_idx, "_combinedGS_lof_boxplot.png"))
...
plot_path <- file.path(figures_ubi_ora_exp_path, "mm909_combinedGS_lof_heat_map.png")
