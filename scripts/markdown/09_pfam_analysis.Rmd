...
plot_path <- file.path(figures_pfam_path, "pfam_heat_map_R_NR_shared.png")
complex_heatmap_pfam(combined_df, plot_path, "Heat Map of PFAM classification of ub genes", 15, 15)
```
