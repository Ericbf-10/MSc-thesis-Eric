...
if(!file.exists(results_ubi_db_path)) {
  dir.create(results_ubi_db_path, recursive = TRUE)
}
...
# Create the folder if it does not exist
if(!file.exists(figures_ubi_db_path)) {
  dir.create(figures_ubi_db_path, recursive = TRUE)
}
