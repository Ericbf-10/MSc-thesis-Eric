...
<!-- ```{r} -->
<!-- # Create the new column 'joined_pos' to check if using distinct to reduce lof_vep_df is possible -->
<!-- nonsyn_mock <- nonsyn_maf_df %>% -->
<!--   mutate(joined_pos = paste0(sample_id, "-", Chromosome, ":", Start_position, "-", End_position)) -->
<!-- ``` -->
...
## Box plot of LoF mutations grouped by response
...
```
### Count SNP, DNP, Missense, Nonsense, Splice, Nonstop
...
# Explore shared LoF mutated genes
