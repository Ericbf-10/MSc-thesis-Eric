...
# Check if any genes belongs to 2 different categories
...
- I don't know why I get so different results compared to Rmd06, I get much less genes annotated.
- The plots belong to annotating Ensembl Gene IDs to go_parent_ids with the mygene package, it has nothing to do with ub_db.
